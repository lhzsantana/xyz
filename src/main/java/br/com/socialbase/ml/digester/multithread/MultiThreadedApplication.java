package br.com.socialbase.ml.digester.multithread;
...
public class MultiThreadedApplication implements CommandLineRunner {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MultiThreadedApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication application = new SpringApplication(MultiThreadedApplication.class);
